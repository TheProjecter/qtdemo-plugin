    ...
    : DemoItem(scene, parent)
{
    ...
    if (el.tagName() == "demos")
        this->readmePath = QtLibraryLocation(QLibraryInfo::DemosPath) + "/README";
    else
        this->readmePath = QtLibraryLocation(QLibraryInfo::ExamplesPath) + "/" + el.attribute("dirname") + "/README";
